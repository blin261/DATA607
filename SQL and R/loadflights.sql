...
LOAD DATA local INFILE 'c:/Users/blin261/Downloads/airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA local INFILE 'c:/Users/blin261/Downloads/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA local INFILE 'c:/Users/blin261/Downloads/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA local INFILE 'c:/Users/blin261/Downloads/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA local INFILE 'c:/Users/blin261/Downloads/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
